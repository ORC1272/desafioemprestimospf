...
//    }
    ...
    @GetMapping("/conta/{id}")
    public ResponseEntity<ContaDto> findById(@PathVariable UUID clienteId) {
        return new ResponseEntity<>(contaMapper.modelToDto(contaRepository.findById(clienteId).get()), HttpStatus.OK);
    }
    @DeleteMapping("/conta/{id}")
    public ResponseEntity<ClienteDto> deleteById(@PathVariable (value = "clienteId") UUID id){
